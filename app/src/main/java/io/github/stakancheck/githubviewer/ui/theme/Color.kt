...
val md_theme_light_background = Color(0xFFF4F5F9) // Белый фон
...
val md_theme_light_surfaceVariant = Color(0xFFE9EDF5)
val md_theme_light_onSurfaceVariant = Color(0xFF090A0C)
...
val md_theme_dark_background = Color(0xFF131313) // Тёмный фон
val md_theme_dark_onBackground = Color(0xFFF6F8FA)
val md_theme_dark_surface = Color(0xFF202123)
...
val md_theme_dark_surfaceVariant = Color(0xFF444549)
val md_theme_dark_onSurfaceVariant = Color(0xFFFFFFFF)
val md_theme_dark_surfaceContainer = Color(0xFF202123)
